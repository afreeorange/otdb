...
const Component = ({
	...
	if (!expression) {
		return (
			<div className="flex bg-amber-300 justify-center align-middle">
				<h1 className="bg-white self-center">
					This is missing expression data
				</h1>
			</div>
		);
	}
						...
						<tr className="bg-base-100 [&>*:not(:last-child)]:border-r [&>*]:p-1">
							<td className="border-t">
								<button
									type="button"
									className={clsx({
										"cursor-pointer underline underline-offset-4 transition-all": true,
