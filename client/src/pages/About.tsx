  ...
  <>
    ...
    <Section>
      <p>
        ...
        means for its author to tinker with technologies that animate the modern
        web. Its utility has been superceded by resources such as{" "}
        <a
        ...
        , which may be interrogated as a refined superset of the data presented
        here.
      </p>
      ...
      >
        <p>
          ...
          <em>Human Eye Transcriptome Atlas</em> provides the largest collection
          of different ocular tissue types, contains the highest number of
          ocular diseases and is characterized by a high level of quality
          achieved by methodological consistency.
        </p>
        <footer className="mt-2 text-sm">
          ...
          <a
            ...
            className="underline underline-offset-4"
          >
            Web-based gene expression analysis &ndash; paving the way to decode
      ...
      <p>
        Annotations for transcript clusters and probesets are based on the Human
        Exon 1.0 ST array from{" "}
        <a
